...
@app.get("/get-friends", summary="Get all friends of the user")      # kasim did this
...
@app.get("/get-pending-friend-requests", summary="Get all pending friends of the user") # kasim did this
