...
class AiModel:
    ...
    def prepare_data(self, data, name, budget, ratingsData=[]):
        ...
        # Create the ratings dataframe and ratings details
...
async def main():
    ...
    # model = AiModel(users, locations, "shopping_spree", ["Japanese food"])
    ...
    # data2 = model.prepare_data(data, 'Group Name', 100, ratings_data)
    # print(data2[0])
    # unpack it, 1 2 3
    '''
    Example Usage:
